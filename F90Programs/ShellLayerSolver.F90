...
close(81)     
open(unit=81,file='Compliance.txt',status='old')
read(81,*) skip
read(81,*) Cmat(1,1), CMat(1,2), sk2, Cmat(1,3), Cmat(1,4)
read(81,*) CMat(2,1), CMat(2,2), sk2, Cmat(2,3), Cmat(2,4)
read(81,*) skip
read(81,*) CMat(3,1), CMat(3,2), sk2, CMat(3,3), Cmat(3,4)
read(81,*) CMat(4,1), CMat(4,2), sk2, CMat(4,3), Cmat(4,4)
Gmat(1,1) = Cmat(3,3)
Gmat(2,2) = Cmat(4,4)
CLOSE(81)
Write(*,*) '================================================'
write(*,*) Cmat(1,1), CMat(1,2), Cmat(1,3), Cmat(1,4)
write(*,*) CMat(2,1), CMat(2,2), Cmat(2,3), Cmat(2,4)
write(*,*) CMat(3,1), CMat(3,2), CMat(3,3), Cmat(3,4)
write(*,*) CMat(4,1), CMat(4,2), CMat(4,3), Cmat(4,4)
write(*,*) GMat(1,1)
write(*,*) GMat(2,2)
Write(*,*) '================================================'
!------------------------------------------------------------------------------
